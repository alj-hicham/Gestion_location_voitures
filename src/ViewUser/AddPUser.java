 ...
 * @author Amine Smaki
 */
public class AddPUser extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
