 ...
 * @author Lenovo
 */
public class FormVehicule extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormVehicule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormVehicule().setVisible(true);
            }
        });
    }
    ...
    public void Suprimer(String a) {

        try {
            int P = JOptionPane.showConfirmDialog(null, " Are you sure want to delete ?", "Confirmation", JOptionPane.YES_NO_OPTION);
            if (P == 0) {
                boolean h = v.supprimer(a);
                if (h == false) {
                    re.supprimerRv(idrev.getText());
    ...
    public void modifier() {
        ...
        try {
            ...
            Logger.getLogger(FormVehicule.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
        ...
        try {
            x = format.parse(dateachat.getText());
        ...
        try {
            ...
            boolean a = v.modifierVh(cle.getText(), v1);
            if (a == false) {
                JOptionPane.showMessageDialog(this, "vous n'avez pas modifié enregistrement correctement", "Voiture", JOptionPane.ERROR_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "vous avez modifié enregistrement correctement", "Voiture", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        modi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImgApp/5.png"))); // NOI18N
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(modi, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(Sup, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void ListerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListerActionPerformed
        ...
        ViewListVehicule li = new ViewListVehicule();
        li.setVisible(true);
        this.dispose();
    ...
    private void SupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SupActionPerformed
        try {
            int P = JOptionPane.showConfirmDialog(this, " Voulez vous vraiment supprimer cette voiture ?", "Confirmation", JOptionPane.YES_NO_OPTION);
            if (P == 0) {
                boolean c = v.supprimer(cle.getText());
                if (c == true) {
                    re.supprimerRv(idrev.getText());
