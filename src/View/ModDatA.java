 ...
 * @author Lenovo
 */
public class ModDatA extends javax.swing.JFrame {
    ...
    Dao.DaoRevsion r = new DaoRevsion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModDatA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (vDate(jTextField3.getText(), "Date d'Asurance")) {
            boolean b = r.modifierAs(jLabel1.getText(), inDate(jTextField3.getText()));

            boolean a = r.listerpan(d, jLabel3.getText());
            if (a == true) {
