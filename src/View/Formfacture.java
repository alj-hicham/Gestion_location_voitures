 ...
 * @author azzus
 */
public class Formfacture extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Formfacture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Formfacture().setVisible(true);
            }
        });
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int c = JOptionPane.showConfirmDialog(null, "voulez vous vraiment supprimer cette facture", "Confirmation", JOptionPane.YES_NO_OPTION);
        if (c == 0) {
            if (fac.supprimer(idf.getText())) {
