 ...
 * @author Lenovo
 */
public class FormContrat extends javax.swing.JFrame {
    ...
    public FormContrat() {
        ...
        try {
            iduser.setText(Choix.getidUser());
        } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormContrat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormContrat().setVisible(true);
            }
        });
    }
    ...
    public void modifer() {
        ...
        String DATEFin = txt1.getText().toString();
        Contrat cont1 = new Contrat(id, DATEDebut, id1, id2, id3, DATEFin, dure, a, b, c);
        boolean h = cont.modifiercont(jLabel5.getText(), cont1);
        if (h == false) {
            JOptionPane.showMessageDialog(this, "vous n'avez pas modifiée enregistrement correctement", "Contrat", JOptionPane.ERROR_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "vous avez modifiée enregistrement correctement", "Contrat", JOptionPane.INFORMATION_MESSAGE);
        }
    }
...
//int days = d.getDays();
    ...
    /**
     * public void chargercombo1() throws SQLException { lcont = cl.Lister ();
     * for (Model.Client l : lcont) { jComboBox1.addItem(l.getCIN()); } This
    ...
    private void initComponents() {
        ...
        delet.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImgApp/1467670055_file_delete.png"))); // NOI18N
        ...
        upt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImgApp/1467670076_file_edit.png"))); // NOI18N
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (verf()) {
            JOptionPane.showMessageDialog(this, "S'il vous plait veeuillez vérifier les dates de maintenance  .", "Erreur", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ajouter();
        try {
    ...
    private void uptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_uptActionPerformed
        ...
        int a = Integer.parseInt(CalculationUp());
        int b = Integer.parseInt(duree.getText());
        if (a == b) {
            modifer();
        } else {
            JOptionPane.showMessageDialog(this, "S'il vous plait calculer la durée .", "Erreur", JOptionPane.ERROR_MESSAGE);
    ...
    private void deletActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletActionPerformed
        try {
            int P = JOptionPane.showConfirmDialog(null, " Voulez vous vraiment supprimer ce Contrat ?", "Confirmation", JOptionPane.YES_NO_OPTION);
            if (P == 0) {

                if (cont.supprimer(jLabel5.getText())) {
